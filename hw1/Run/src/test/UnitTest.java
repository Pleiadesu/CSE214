...
public class UnitTest {
    ...
    public static boolean TestAddInverse(Ring a) {
        System.out.println("Testing AddInverse");
        Ring b = a.addInverse();
        Ring x = a.add(b);
        Ring y = b.add(a);
    ...
    public static boolean TestMulIdentity(Field a) {
        System.out.println("Testing MulIdentity");
    ...
    public static boolean TestMulInverse(Field a) {
        System.out.println("Testing MulInverse");
        Ring b = a.mulInverse();
        Ring x = a.mul(b);
        Ring y = b.mul(a);
    ...
    public static boolean TestAntisymmetry(Ordered a, Ordered b) {
        System.out.println("Testing Antisymmetry");
        if(a.ge(b))
            return !b.ge(a);
        else
            return b.ge(a);
    ...
    public static void TestEuclidean(Ring a, Ring b, Ring c) {
        System.out.println("Testing Euclidean");
